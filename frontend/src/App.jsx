...
import { Upload, X, Check, AlertTriangle, Play, Shield, ShieldAlert, Cpu, Activity, Clock, Database, ChevronRight } from 'lucide-react';
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                ...
                <header className="flex justify-between items-center mb-12">
                    ...
                    <div className="flex items-center gap-4">
                        {demoVideos.length > 0 && (
                            <div className="hidden md:flex items-center gap-2 text-xs font-medium text-cyan-400 bg-cyan-950/30 border border-cyan-500/20 px-3 py-1.5 rounded-full">
                                <Database className="w-3 h-3" />
                                {demoVideos.length} Dataset Videos Available
                            </div>
                        )}
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        ...
                        <div className="bg-neutral-900/50 border border-white/5 rounded-3xl overflow-hidden backdrop-blur-sm">
                            <div className="p-5 border-b border-white/5 flex justify-between items-center">
                                ...
                                <span className="text-xs text-neutral-500">Fetched from HuggingFace</span>
                            </div>
